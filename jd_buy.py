...
class JDWrapper(object):
	...
	def good_stock(self, stock_id, good_count=2, area_id=None):
		'''
		33 : on sale, 
		34 : out of stock
		'''
	...
	def buy(self, options):
		...
		goodsList = ['4993737','4993773','4993751']
		str = random.choice(goodsList)
		options.good = str
		# stock detail
...
def main(options):
 ...
 #   	qr_ticket = None
	...
	str = raw_input("请输入任意字符串回车开始购买");
	
	#无限循环模式
	var = 1
	while var == 1:
		canBuy = jd.buy(options)
		if canBuy:
			print "可以购买"
			pass
		print "失败"
